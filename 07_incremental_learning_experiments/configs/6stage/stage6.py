...
log_level = 'INFO'
work_dir = 'work_dirs/incremental_v4/6stage/stage6'
...
load_from = 'work_dirs/incremental_v4/6stage/stage5/latest.pth'
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            data_root=data_root,
            ann_file=data_root + 'v4_3dbox/6stage/sunrgbd_infos_train_stage6.pkl',
