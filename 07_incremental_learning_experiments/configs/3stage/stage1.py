...
# Schedule: 3stage | Stage 1/3 (scene_type: classroom)
...
log_level = 'INFO'
work_dir = 'work_dirs/incremental_v4/3stage/stage1'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            data_root=data_root,
            ann_file=data_root + 'v4_3dbox/3stage/sunrgbd_infos_train_stage1.pkl',
    ...
    val=dict(
        ...
        modality=dict(use_camera=False, use_lidar=True),
        data_root=data_root,
        ann_file=data_root + 'v4_3dbox/3stage/sunrgbd_infos_val_stage1.pkl',
